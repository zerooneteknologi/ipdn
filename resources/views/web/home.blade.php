        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 content" data-aos="fade-left" dat-aos-delay="100">
                    ...
                    <div class="lh-lg">
                        {!! Str::between(Str::limit($profile->article_description, 200), '<div>', '</div>') !!}
                    </div>
                    <br>
                    <a href="{{ route('articlesingle', $profile->article_slug) }}"
                        class="btn btn-primary justify-center mt-3">Selengkapnya</a>
                </div>
            </div>
                    ...
                    <div class="col-md-4 col py-4 my-2 my-sm-3" data-aos="fade-up">
                        <a href="{{ route('scemesingle', $sceme->sceme_slug) }}"
                            ...
                            <div class="card-body pt-3">
                                <div class="d-inline-block shadow rounded-3 position-absolute top-0 translate-middle-y">
                ...
                <div class="col-xl-9">
                    <div class="row">
                        @foreach ($assesors as $assesor)
                            <div class="col-lg-3 col-md-6 shadow mx-3">
                        ...
                        <div class="card border-primary h-100 d-flex flex-column">
                            @if ($announcement->article_image)
                                <img src="{{ asset('ipdn/storage/app/public/' . $announcement->article_image) }}"
                                    class="card-img-top w-100" alt="{{ $announcement->article_title }}"
                                    style="min-height: 400px; max-height: 400px; object-fit: contain;">
                            @else
                                <img src="/assets/img/logo/noimage.png" class="card-img-top" alt="no image"
                                    style="min-height: 400px; max-height: 400px;">
                            @endif
                            <div class="card-body flex-grow-1">
                                <h5 class="card-title fw-bold">{{ $announcement->article_title }}</h5>
                                <div style="min-height: 50px">{!! Str::between(Str::limit($announcement->article_description, 50), '<div>', '</div>') !!}</div>
                                <a href="{{ route('articlesingle', $announcement->article_slug) }}?type=4"
                                    class="btn btn-primary mb-3">Selengkapnya</a>
                            </div>
                            <div class="card-footer mt-auto bg-warning">
    ...
    <section id="call-to-action">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-9 text-center text-lg-start">
                    <div class="owl-carousel owl-theme">
                        @foreach ($articles as $article)
                            <div class="item" style="min-height: 485px; max-height: 485px;">
                                <div class="packages-item">
                                    ...
                                    <div class="packages-content bg-light">
                                        <div class="p-4 pb-0">
                                            <h6 class="mb-1 fw-bold">{{ $article->article_title }}</h6>
                                            <span
                                                class="text-uppercase badge text-bg-warning">{{ $article->created_at->diffForHumans() }}</span>
                                            <div class="mb-3">
                                            ...
                                            {!! Str::between(Str::limit($announcement->article_description, 50), '<div>', '</div>') !!}
                                        </div>
                                        <div class="row bg-primary rounded-bottom mx-0 mt-3">
                ...
                @foreach ($partners as $partner)
                    @if ($partner->partner_image)
                        <img src="{{ asset('ipdn/storage/app/public/' . $partner->partner_image) }}"
                            alt="{{ $partner->partner_name }}" class="img-fluid m-3"
