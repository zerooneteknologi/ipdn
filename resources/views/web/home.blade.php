                        ...
                        <div class="card border-primary mb-3">
                            ...
                            <div class="card-body text-primary">
                                ...
                                <div class="card-footer">
                                    <small
                                        class="text-muted">{{ date_format($announcement->created_at, 'd M Y') }}</small>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-3 cta-btn-container text-center">
                    <div
                        ...
                        <button class="btn btn-outline-light"><i class="bi bi-chevron-left fs-4 text-dark"></i></button>
                        <a href="{{ route('articles') }}?type=3" class="cta-btn align-middle">Lihat semua</a>
                        <button class="btn btn-outline-light"><i class="bi bi-chevron-right fs-4 text-dark"></i></button>
                    </div>
                    <div class="custom-controls">
                        <div class="owl-dots"></div>
                    </div>
                </div>
                <div class="col-lg-9 text-center text-lg-start row">
                                ...
                                <div class="packages-item">
                                    ...
                                    <div class="packages-content bg-light">
                                        <div class="p-4 pb-0">
                                            ...
                                            <p class="mb-4">
                                                {{ Str::after(Str::limit($article->article_description, 50, '...'), '<div>') }}
                                            </p>
                                        </div>
