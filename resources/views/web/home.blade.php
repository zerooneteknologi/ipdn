                        ...
                        <div class="packages-item">
                            ...
                            <div class="packages-content bg-light">
                                <div class="p-4 pb-0">
                                    ...
                                    {!! Str::between(Str::limit($announcement->article_description, 50), '<div>', '
                                    </div>') !!}
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="d-flex flex-wrap justify-content-center align-items-center">
            ...
            <img src="{{ asset('ipdn/storage/app/public/' . $partner->partner_image) }}"
                alt="{{ $partner->partner_name }}" class="img-fluid m-3" style="height: 100px; object-fit: contain;">
            @endif
            @endforeach
        </div>
    </div>
