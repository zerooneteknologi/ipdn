    ...
    <a href="{{ route('scemesingle', $sceme->sceme_slug)}}"
        ...
        <div class="card-body pt-3">
            <div class="d-inline-block bg-primary rounded-3 position-absolute top-0 translate-middle-y p-3">
                ...
                <img src="{{ asset('ipdn/storage/app/public/'. $sceme->sceme_image) }}" class="d-block m-1 img-fluid"
                    width="100" alt="{{ $sceme->sceme_name}}" style="max-height: 100px; min-height: 100px" />
                @else
