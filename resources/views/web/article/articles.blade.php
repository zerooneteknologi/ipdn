                        ...
                        <div class="col-sm-6 col-md-2 position-relative bg-repeat-0 bg-size-cover">
                            ...
                            @else
                                <img src="/assets/img/logo/noimage.png" class="img-fluid rounded-start mr-3"
                                    alt="no image" style="height: 150px; object-fit: cover; width: 100%" />
                            @endif
                        ...
                        <div class="col-sm-6 col-md-10">
                            <div class="card-body">
                                <div class="align-items-center mb-3">
                                    ...
                                    @if (request('type') == 3)
                                        <a href="#"
                                            class="badge fs-sm text-nav bg-warning text-decoration-none ps-3">
                                ...
                                <p>
                                    {!! Str::after(
                                        Str::limit($article->article_description, 100, '...'),
                                        '
                                                                <div>',
                                    ) !!}
                                </p>
