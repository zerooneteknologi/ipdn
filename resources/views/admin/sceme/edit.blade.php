                ...
                <form method="POST" action="{{ route('sceme.update', $sceme->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-3">
                            ...
                            <input value="{{ $sceme->sceme_name }}" name="sceme_name" id="sceme_name" type="text"
                                class="form-control" required>

                            <label for="sceme_code" class="col-form-label">Kode Skema</label>
                            <input value="{{ $sceme->sceme_code }}" id="sceme_code" name="sceme_code" type="text"
                                class="form-control" required>
                            ...
                            <select id="sceme_status" name="sceme_status" class="form-select"
                                ...
                                <option value="2" {{ $sceme->sceme_status == 2 ? 'selected' : '' }}>Tidak Aktif
                                </option>
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-12">
                            <input value="{{ $sceme->sceme_detail }}" id="sceme_detail" type="hidden" name="sceme_detail"
                                required>
